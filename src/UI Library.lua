...
local library = utility.table({theme = table.clone(themes.Supreme), folder = "Supreme V1", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
-- Edited by Supreme for Supreme V1
